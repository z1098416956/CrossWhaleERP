...
@Service
public class GoodsAttributeInfoServiceImpl implements GoodsAttributeInfoService {

    @Resource
    private GoodsAttributeInfoDao goodsAttributeInfoDao;
    ...
    public CommonResult<Void> createGoodsAttributeInfo(CreateGoodsInfoReqVO createGoodsInfoReqVO, Long goodsId) {
        ...
        goodsAttributeInfoDao.insert(goodsAttributeInfoDOList);
